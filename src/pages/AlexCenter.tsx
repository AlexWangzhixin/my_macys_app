...
export default function AlexCenter() {
	const { orders, acceptOrder, completeOrder, isAuthenticated, logout, requestReward } = useContext(AuthContext);
		...
		<div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
			...
			<main className="container mx-auto px-4 pb-16">
				...
				<div className="mb-6 flex items-center justify-between">
					<div className="text-sm text-gray-500">已完成 {counters.completed} 单，可申请奖励</div>
					<button onClick={requestReward} className="px-4 py-2 rounded-xl bg-amber-500 text-white hover:bg-amber-600 shadow">
						申请奖励
					</button>
				</div>
